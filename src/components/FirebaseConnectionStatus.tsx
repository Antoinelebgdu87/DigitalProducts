...
const FirebaseConnectionStatus: React.FC = () => {
  ...
  return (
    <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 max-w-md">
      <Alert className={`border-2 ${isOnline ? 'border-green-500 bg-green-50 dark:bg-green-950' : 'border-orange-500 bg-orange-50 dark:bg-orange-950'}`}>
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <span className="font-medium text-sm">
                {isChecking ? 'Vérification...' : isOnline ? 'Connexion rétablie' : 'Mode déconnecté'}
              </span>
