...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  ...
  en: {
    ...
    // Buttons & Actions
    "btn.join_discord": "Join Discord",
    "btn.learn_more": "Learn More",
    "btn.explore_products": "Explore Products",
    "btn.preview": "Preview",
    ...
    "product.support": "Support",
    "product.instant_download": "Instant Download",
    "product.no_account_required": "No Account Required",
    ...
    // Modals
    "modal.username.title": "Choose Username",
    "modal.username.placeholder": "Enter your username",
    "modal.username.create": "Create",
    "modal.ban.title": "Account Suspended",
    "modal.warning.title": "Warning",
    "modal.tos.title": "Terms of Service",
    "modal.tos.accept": "Accept",
    "modal.tos.decline": "Decline",
    ...
    // Features & Benefits
    "feature.instant_access": "Instant Access",
    "feature.no_drm": "DRM-Free",
    "feature.lifetime_updates": "Lifetime Updates",
    "feature.customer_support": "Customer Support",
    "feature.money_back": "Money-Back Guarantee",
    "feature.secure_payment": "Secure Payment",
    "feature.fast_download": "Fast Download",
    "feature.high_quality": "High Quality",
  },
  pt: {
    // Navigation & UI
    "nav.home": "Início",
  ...
  ja: {
    ...
    "home.description": "プレミアムデジタル製品コレクションを発��",
    "home.featured": "注目商品",
    "home.shop": "ショップ",
