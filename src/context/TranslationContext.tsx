...
class HybridTranslationService {
  ...
  private staticTranslations: Record<Language, Record<string, string>> = {
    en: {
      ...
      "Configurez la langue d'affichage et activez la traduction automatique avec IA.":
        "Configure display language and enable automatic AI translation.",
      "Traduction IA": "AI Translation",
      Gratuit: "Free",
      "Activez la traduction automatique de tous les textes avec OpenRouter AI":
        "Enable automatic translation of all texts with OpenRouter AI",
      ...
      "Traduction hybride avec dictionnaire intégré et API LibreTranslate gratuite.":
        "Hybrid translation with integrated dictionary and free LibreTranslate API.",
      "Les traductions sont mises en cache pour des performances optimales.":
        "Translations are cached for optimal performance.",
      ...
      "Handpicked collection of premium digital assets, tools, and resources for creators and professionals.":
        "Handpicked collection of premium digital assets, tools, and resources for creators and professionals.",
      "Loading Products": "Loading Products",
      "Fetching the latest digital products...":
        "Fetching the latest digital products...",
      "Coming Soon": "Coming Soon",
      "Amazing products are being curated for you. Stay tuned for something incredible!":
        "Amazing products are being curated for you. Stay tuned for something incredible!",
      "All rights reserved": "All rights reserved",

      // Conditions d'utilisation
      "Conditions d'Utilisation": "Terms of Service",
      "Accord Légal et Directives d'Usage":
      ...
      "En utilisant DigitalHub, vous reconnaissez avoir lu, compris et accepté d'être lié par ces Conditions d'Utilisation.":
        "By using DigitalHub, you acknowledge that you have read, understood and agreed to be bound by these Terms of Service.",
      ...
      "TOUTES LES VENTES SONT FINALES - AUCUN REMBOURSEMENT":
      ...
      "Comptes Utilisateur et Responsabilités":
      ...
      "Avertissements et Limitation de Responsabilité":
        "Warnings and Limitation of Liability",
      ...
      "Ces Conditions seront interprétées et régies par les lois de la France":
      ...
      "Veuillez ne pas nous contacter concernant des demandes de remboursement, car toutes les ventes sont finales.":
        "Please do not contact us regarding refund requests, as all sales are final.",
      ...
      "Veuillez respecter les règles de la plateforme pour éviter de futurs avertissements.":
        "Please respect platform rules to avoid future warnings.",
      "Les avertissements répétés peuvent conduire à un bannissement.":
        "Repeated warnings may lead to a ban.",
      ...
      "En acceptant, vous acceptez nos Conditions d'Utilisation complètes.":
        "By accepting, you agree to our complete Terms of Service.",
    ...
    pt: {
      ...
      "Configurez la langue d'affichage et activez la traduction automatique avec IA.":
        "Configure o idioma de exibição e ative a tradução automática com IA.",
      "Traduction IA": "Tradução IA",
      Gratuit: "Grátis",
      "Activez la traduction automatique de tous les textes avec OpenRouter AI":
        "Ative a tradução automática de todos os textos com OpenRouter AI",
      "Traduction en cours...": "Traduzindo...",
      "Langue d'affichage": "Idioma de Exibição",
      "Service de traduction": "Serviço de Tradução",
      "Traduction hybride avec dictionnaire intégré et API LibreTranslate gratuite.":
        "Tradução híbrida com dicionário integrado e API LibreTranslate gratuita.",
      "Les traductions sont mises en cache pour des performances optimales.":
        "As traduções são armazenadas em cache para desempenho ideal.",
      ...
      "Discover exceptional digital products with instant access.":
        "Descubra produtos digitais excepcionais com acesso instantâneo.",
      ...
      "Handpicked collection of premium digital assets, tools, and resources for creators and professionals.":
        "Coleção selecionada de ativos digitais premium, ferramentas e recursos para criadores e profissionais.",
      "Loading Products": "Carregando Produtos",
      "Fetching the latest digital products...":
        "Buscando os produtos digitais mais recentes...",
      "Coming Soon": "Em Breve",
      "Amazing products are being curated for you. Stay tuned for something incredible!":
        "Produtos incríveis estão sendo selecionados para você. Fique ligado para algo incrível!",
      ...
      "En utilisant DigitalHub, vous reconnaissez avoir lu, compris et accepté d'être lié par ces Conditions d'Utilisation.":
        "Ao usar o DigitalHub, você reconhece ter lido, compreendido e concordado em estar vinculado a estes Termos de Serviço.",
      ...
      "TOUTES LES VENTES SONT FINALES - AUCUN REMBOURSEMENT":
        "TODAS AS VENDAS SÃO FINAIS - SEM REEMBOLSO",
      "Changement d'avis après achat": "Mudança de opinião após compra",
      "Incompatibilité technique avec les systèmes utilisateur":
        "Incompatibilidade técnica com sistemas do usuário",
      "Comptes Utilisateur et Responsabilités":
        "Contas de Usuário e Responsabilidades",
      "Droits de Propriété Intellectuelle":
        "Direitos de Propriedade Intelectual",
      "Vous ne pouvez PAS :": "Você NÃO pode:",
      "Revendre, redistribuer ou partager les produits achetés":
        "Revender, redistribuir ou compartilhar produtos comprados",
      "Avertissements et Limitation de Responsabilité":
      ...
      "Ces Conditions seront interprétées et régies par les lois de la France":
        "Estes Termos serão interpretados e regidos pelas leis da França",
      Divisibilité: "Divisibilidade",
      "Informations de Contact": "Informações de Contato",
      "Avis Important": "Aviso Importante",
      "Veuillez ne pas nous contacter concernant des demandes de remboursement, car toutes les ventes sont finales.":
        "Por favor, não nos contate sobre solicitações de reembolso, pois todas as vendas são finais.",

      // Modais de usuário
      "Bienvenue !": "Bem-vindo!",
      "Créez votre nom d'utilisateur pour accéder à la plateforme":
        "Crie seu nome de usuário para acessar a plataforma",
      "Nom d'utilisateur": "Nome de usuário",
      "Entrez votre pseudo": "Digite seu apelido",
      "Générer un nouveau pseudo": "Gerar novo apelido",
      "Ou utilisez le pseudo généré automatiquement":
        "Ou use o apelido gerado automaticamente",
      "Création...": "Criando...",
      "Créer mon compte": "Criar minha conta",
      "Votre pseudo sera visible par les autres utilisateurs":
        "Seu apelido será visível para outros usuários",
      ...
      "Avertissement :": "Aviso:",
      "Veuillez respecter les règles de la plateforme pour éviter de futurs avertissements.":
        "Por favor, respeite as regras da plataforma para evitar futuros avisos.",
      "Les avertissements répétés peuvent conduire à un bannissement.":
        "Avisos repetidos podem levar a um banimento.",
      "J'ai compris": "Entendi",

      // Modal ToS
      "Veuillez accepter nos Conditions pour continuer":
        "Por favor, aceite nossos Termos para continuar",
      Accepter: "Aceitar",
      Refuser: "Recusar",
      ...
      "En acceptant, vous acceptez nos Conditions d'Utilisation complètes.":
        "Ao aceitar, você concorda com nossos Termos de Serviço completos.",
    ...
    es: {
      ...
      "Configurez la langue d'affichage et activez la traduction automatique avec IA.":
        "Configure el idioma de visualización y active la traducción automática con IA.",
      "Traduction IA": "Traducción IA",
      Gratuit: "Gratis",
      "Activez la traduction automatique de tous les textes avec OpenRouter AI":
        "Active la traducción automática de todos los textos con OpenRouter AI",
      "Traduction en cours...": "Traduciendo...",
      "Langue d'affichage": "Idioma de Visualización",
      "Service de traduction": "Servicio de Traducción",
      "Traduction hybride avec dictionnaire intégré et API LibreTranslate gratuite.":
        "Traducción híbrida con diccionario integrado y API LibreTranslate gratuita.",
      "Les traductions sont mises en cache pour des performances optimales.":
        "Las traducciones se almacenan en caché para un rendimiento óptimo.",
      ...
      "Discover exceptional digital products with instant access.":
        "Descubre productos digitales excepcionales con acceso instantáneo.",
      ...
      "Handpicked collection of premium digital assets, tools, and resources for creators and professionals.":
        "Colección seleccionada de activos digitales premium, herramientas y recursos para creadores y profesionales.",
      "Loading Products": "Cargando Productos",
      "Fetching the latest digital products...":
        "Obteniendo los productos digitales más recientes...",
      "Coming Soon": "Próximamente",
      "Amazing products are being curated for you. Stay tuned for something incredible!":
        "¡Productos increíbles están siendo seleccionados para ti. ¡Mantente atento para algo increíble!",
      "All rights reserved": "Todos los derechos reservados",

      // Términos de servicio
      "Conditions d'Utilisation": "Términos de Servicio",
      "Accord Légal et Directives d'Usage":
        "Acuerdo Legal y Directrices de Uso",
      ...
      "En utilisant DigitalHub, vous reconnaissez avoir lu, compris et accepté d'être lié par ces Conditions d'Utilisation.":
        "Al usar DigitalHub, reconoces haber leído, entendido y aceptado estar sujeto a estos Términos de Servicio.",

      // Modales de usuario
      "Bienvenue !": "¡Bienvenido!",
      "Créez votre nom d'utilisateur pour accéder à la plateforme":
        "Crea tu nombre de usuario para acceder a la plataforma",
      "Nom d'utilisateur": "Nombre de usuario",
      "Entrez votre pseudo": "Ingresa tu apodo",
      "Générer un nouveau pseudo": "Generar nuevo apodo",
      "Ou utilisez le pseudo généré automatiquement":
        "O usa el apodo generado automáticamente",
      "Création...": "Creando...",
      "Créer mon compte": "Crear mi cuenta",
      "Votre pseudo sera visible par les autres utilisateurs":
        "Tu apodo será visible para otros usuarios",
      ...
      "Veuillez respecter les règles de la plateforme pour éviter de futurs avertissements.":
        "Por favor, respeta las reglas de la plataforma para evitar futuras advertencias.",
      "Les avertissements répétés peuvent conduire à un bannissement.":
        "Las advertencias repetidas pueden llevar a un baneo.",
      ...
      "Produits fournis 'en l'état'":
        "Productos proporcionados 'tal como están'",
      "Licence personnelle uniquement": "Licencia personal únicamente",
      "En acceptant, vous acceptez nos Conditions d'Utilisation complètes.":
        "Al aceptar, aceptas nuestros Términos de Servicio completos.",
    ...
    de: {
      ...
      "Configurez la langue d'affichage et activez la traduction automatique avec IA.":
        "Konfigurieren Sie die Anzeigesprache und aktivieren Sie die automatische KI-Übersetzung.",
      "Traduction IA": "KI-Übersetzung",
      Gratuit: "Kostenlos",
      "Activez la traduction automatique de tous les textes avec OpenRouter AI":
        "Aktivieren Sie die automatische Übersetzung aller Texte mit OpenRouter AI",
      "Traduction en cours...": "Übersetzen...",
      "Langue d'affichage": "Anzeigesprache",
      "Service de traduction": "Übersetzungsdienst",
      "Traduction hybride avec dictionnaire intégré et API LibreTranslate gratuite.":
        "Hybride Übersetzung mit integriertem Wörterbuch und kostenloser LibreTranslate API.",
      "Les traductions sont mises en cache pour des performances optimales.":
        "Übersetzungen werden für optimale Leistung zwischengespeichert.",
      ...
      "Discover exceptional digital products with instant access.":
        "Entdecken Sie außergewöhnliche digitale Produkte mit sofortigem Zugang.",
      ...
      "Handpicked collection of premium digital assets, tools, and resources for creators and professionals.":
        "Handverlesene Sammlung von Premium-Digital-Assets, Tools und Ressourcen für Kreative und Profis.",
      "Loading Products": "Produkte Werden Geladen",
      "Fetching the latest digital products...":
        "Die neuesten digitalen Produkte werden geladen...",
      "Coming Soon": "Bald Verfügbar",
      "Amazing products are being curated for you. Stay tuned for something incredible!":
        "Erstaunliche Produkte werden für Sie kuratiert. Bleiben Sie dran für etwas Unglaubliches!",
      "All rights reserved": "Alle Rechte vorbehalten",

      // Benutzermodals
      "Bienvenue !": "Willkommen!",
      "Créez votre nom d'utilisateur pour accéder à la plateforme":
        "Erstellen Sie Ihren Benutzernamen, um auf die Plattform zuzugreifen",
      ...
      "Ou utilisez le pseudo généré automatiquement":
        "Oder verwenden Sie den automatisch generierten Spitznamen",
      "Création...": "Erstellen...",
      "Créer mon compte": "Mein Konto erstellen",
      "Votre pseudo sera visible par les autres utilisateurs":
        "Ihr Spitzname wird für andere Benutzer sichtbar sein",
    ...
    it: {
      ...
      "Configurez la langue d'affichage et activez la traduction automatique avec IA.":
        "Configura la lingua di visualizzazione e attiva la traduzione automatica con IA.",
      "Traduction IA": "Traduzione IA",
      Gratuit: "Gratuito",
      "Activez la traduction automatique de tous les textes avec OpenRouter AI":
        "Attiva la traduzione automatica di tutti i testi con OpenRouter AI",
      ...
      "Traduction hybride avec dictionnaire intégré et API LibreTranslate gratuite.":
        "Traduzione ibrida con dizionario integrato e API LibreTranslate gratuita.",
      "Les traductions sont mises en cache pour des performances optimales.":
        "Le traduzioni sono memorizzate nella cache per prestazioni ottimali.",
      ...
      "Discover exceptional digital products with instant access.":
        "Scopri prodotti digitali eccezionali con accesso istantaneo.",
      ...
      "Handpicked collection of premium digital assets, tools, and resources for creators and professionals.":
        "Collezione selezionata di asset digitali premium, strumenti e risorse per creatori e professionisti.",
      "Loading Products": "Caricamento Prodotti",
      "Fetching the latest digital products...":
        "Recupero degli ultimi prodotti digitali...",
      "Coming Soon": "Prossimamente",
      "Amazing products are being curated for you. Stay tuned for something incredible!":
        "Prodotti straordinari sono in corso di selezione per te. Resta sintonizzato per qualcosa di incredibile!",
      "All rights reserved": "Tutti i diritti riservati",

      // Modali utente
      "Bienvenue !": "Benvenuto!",
      "Créez votre nom d'utilisateur pour accéder à la plateforme":
        "Crea il tuo nome utente per accedere alla piattaforma",
      ...
      "Ou utilisez le pseudo généré automatiquement":
        "O usa il nickname generato automaticamente",
      "Création...": "Creazione...",
      "Créer mon compte": "Crea il mio account",
      "Votre pseudo sera visible par les autres utilisateurs":
        "Il tuo nickname sarà visibile agli altri utenti",
  ...
  async translateText(text: string, targetLanguage: Language): Promise<string> {
    ...
    try {
      ...
      const libreTranslateResult = await this.tryLibreTranslate(
        text,
        targetLanguage,
      );
  ...
  private async tryLibreTranslate(
    text: string,
    targetLanguage: Language,
  ): Promise<string | null> {
    try {
